...
public class MyTestLNF extends DefaultMetalTheme {

    @Override
	public String getName() { return "Phase2"; }

    private final ColorUIResource primary1 = new ColorUIResource(186,0,0); // labels ?
    private final ColorUIResource primary2 = new ColorUIResource(255,204,122); // menu hlgt,sliderbar,node hghlght 
    ...
    // s3alt 153,204,204
    private final ColorUIResource secondary3 = new ColorUIResource(200,212,42); // bgs menu, dlg, popup, frame
